...
<meta name="google-site-verification" content="mqQ_93B8YKkh_3RRw26RrNgNeVXOxi5EUfjIm3ycE0w" />
	...
	<div id="header" class="col-full">
		...
		<div id="logo" class="fl">
	      	...
	      	<?php if(is_single() || is_page()) : ?>
	      		<span class="site-title"><a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); echo '/images/si_badge_150.png'; ?>" width="150" height="150" alt="Si" /></a></span>
	      	<?php else: ?>
	      		<h1 class="site-title"><a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); echo '/images/si_badge_150.png'; ?>" width="150" height="150" alt="Si" /></a></h1>
	      	<?php endif; ?>	      	
